    ...
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-color: #06284A">
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
            ...
            <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                ...
                <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo1/dist/index.html" action="{{route('login')}}">
                    @csrf
                    <!--begin::Heading-->
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <div class="d-flex flex-stack mb-2">
                            ...
                            <!--end::Label-->
                            <!--begin::Link-->
                            <a href="../../demo1/dist/authentication/layouts/dark/password-reset.html" class="link-primary fs-6 fw-bolder">Esquceu a senha ?</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Input-->
